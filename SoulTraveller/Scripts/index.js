$(function () {
    ...
    function setHtml(objs) {
        ...
        + objs[it].Summary + '</td></tr><tr><td><i class="fa fa-comments"> 评论(' + objs[it].Comment + ')</i></td><td><i class="fa fa-share-alt"> '
        + '分享(' + objs[it].Shared + ')</i></td><td><i class="fa fa-heart"> 浏览(' + objs[it].Views + ')</i></td><td><i class="fa fa-thumbs-up"> '
